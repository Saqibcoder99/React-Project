...
function App() {
  ...
  return (
    ...
    <>
      <nav className='bg-[#fcfcfd] h-[60px]  shadow-md flex items-center p-2 rounded-[8px] fixed left-5 right-5  '>
      ...
      <footer className='bg-[#fcfcfd] h-[60px] shadow-md flex items-center justify-between  px-2 py-4 rounded-[8px] text-gray-700 mx-5 sm:px-4'>
        <div className='flex gap-2 text-[12px]  items-center sm:gap-4 sm:text-[18px]'>
          <p>Show</p>
